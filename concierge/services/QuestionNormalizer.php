...
final class QuestionNormalizer
{
    ...
    public static function extractKeywords(string $question): array
    {
        ...
        $stopWords = [
            ...
            'by','can','could','do','does','for','from','had','has','have',
            'how','i','if','in','is','it','may','me','my','of','on','or',
            'our','should','that','the','their','there','they','this','to',
        ...
        foreach ($parts as $part) {
            ...
            if (mb_strlen($part) > 4 && str_ends_with($part, 's')) {
                $keywords[] = mb_substr($part, 0, mb_strlen($part) - 1);
            }
        }
